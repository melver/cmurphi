...
public:
  ...
  virtual void print_trace_dfs(NextStateGenerator *) {
    Error.Notrace
	("Internal: Generating counterexample from a state queue instead of a state stack.");
  }
...
public:
  ...
  virtual void print_capacity(void) {
    cout << "\t* Capacity in stack for depth-first search: "
	<< max_active_states << " states.\n";
  }
